...
GO
PRINT N'Creating Table [dbo].[Weights]...';
...
GO
PRINT N'Creating Foreign Key [dbo].[FK_Weights_ToPerson]...';


GO
ALTER TABLE [dbo].[Weights]
    ADD CONSTRAINT [FK_Weights_ToPerson] FOREIGN KEY ([PersonId]) REFERENCES [dbo].[Persons] ([Id]);
